...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return pt.sharespot.iot.core.sensor.buf.Sensor.internal_static_pt_sharespot_iot_core_Velocity_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return pt.sharespot.iot.core.sensor.buf.Sensor.internal_static_pt_sharespot_iot_core_Velocity_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            pt.sharespot.iot.core.sensor.buf.Velocity.class, pt.sharespot.iot.core.sensor.buf.Velocity.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof pt.sharespot.iot.core.sensor.buf.Velocity)) {
      return super.equals(obj);
    }
    pt.sharespot.iot.core.sensor.buf.Velocity other = (pt.sharespot.iot.core.sensor.buf.Velocity) obj;
  ...
  public static pt.sharespot.iot.core.sensor.buf.Velocity parseFrom(
  ...
  public static pt.sharespot.iot.core.sensor.buf.Velocity parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static pt.sharespot.iot.core.sensor.buf.Velocity parseFrom(
  ...
  public static pt.sharespot.iot.core.sensor.buf.Velocity parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static pt.sharespot.iot.core.sensor.buf.Velocity parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static pt.sharespot.iot.core.sensor.buf.Velocity parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(pt.sharespot.iot.core.sensor.buf.Velocity prototype) {
  ...
  public static final class Builder extends
      ...
      pt.sharespot.iot.core.sensor.buf.VelocityOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pt.sharespot.iot.core.sensor.buf.Sensor.internal_static_pt_sharespot_iot_core_Velocity_descriptor;
    }
    ...
    // Construct using pt.sharespot.iot.core.sensor.buf.Velocity.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.sensor.buf.Velocity getDefaultInstanceForType() {
      return pt.sharespot.iot.core.sensor.buf.Velocity.getDefaultInstance();
    }

    @java.lang.Override
    public pt.sharespot.iot.core.sensor.buf.Velocity build() {
      pt.sharespot.iot.core.sensor.buf.Velocity result = buildPartial();
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.sensor.buf.Velocity buildPartial() {
      pt.sharespot.iot.core.sensor.buf.Velocity result = new pt.sharespot.iot.core.sensor.buf.Velocity(this);
      if (kilometersPerHourBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof pt.sharespot.iot.core.sensor.buf.Velocity) {
        return mergeFrom((pt.sharespot.iot.core.sensor.buf.Velocity)other);
      } else {
    ...
    public Builder mergeFrom(pt.sharespot.iot.core.sensor.buf.Velocity other) {
      if (other == pt.sharespot.iot.core.sensor.buf.Velocity.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      pt.sharespot.iot.core.sensor.buf.Velocity parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (pt.sharespot.iot.core.sensor.buf.Velocity) e.getUnfinishedMessage();
  ...
  private static final pt.sharespot.iot.core.sensor.buf.Velocity DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new pt.sharespot.iot.core.sensor.buf.Velocity();
  }

  public static pt.sharespot.iot.core.sensor.buf.Velocity getDefaultInstance() {
