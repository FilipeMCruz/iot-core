...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_Distance_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_Distance_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            pt.sharespot.iot.core.data.buf.Distance.class, pt.sharespot.iot.core.data.buf.Distance.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof pt.sharespot.iot.core.data.buf.Distance)) {
      return super.equals(obj);
    }
    pt.sharespot.iot.core.data.buf.Distance other = (pt.sharespot.iot.core.data.buf.Distance) obj;
  ...
  public static pt.sharespot.iot.core.data.buf.Distance parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.Distance parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static pt.sharespot.iot.core.data.buf.Distance parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.Distance parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static pt.sharespot.iot.core.data.buf.Distance parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static pt.sharespot.iot.core.data.buf.Distance parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(pt.sharespot.iot.core.data.buf.Distance prototype) {
  ...
  public static final class Builder extends
      ...
      pt.sharespot.iot.core.data.buf.DistanceOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_Distance_descriptor;
    }
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.Distance getDefaultInstanceForType() {
      return pt.sharespot.iot.core.data.buf.Distance.getDefaultInstance();
    }

    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.Distance build() {
      pt.sharespot.iot.core.data.buf.Distance result = buildPartial();
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.Distance buildPartial() {
      pt.sharespot.iot.core.data.buf.Distance result = new pt.sharespot.iot.core.data.buf.Distance(this);
      if (millimetersBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof pt.sharespot.iot.core.data.buf.Distance) {
        return mergeFrom((pt.sharespot.iot.core.data.buf.Distance)other);
      } else {
    ...
    public Builder mergeFrom(pt.sharespot.iot.core.data.buf.Distance other) {
      if (other == pt.sharespot.iot.core.data.buf.Distance.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      pt.sharespot.iot.core.data.buf.Distance parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (pt.sharespot.iot.core.data.buf.Distance) e.getUnfinishedMessage();
  ...
  private static final pt.sharespot.iot.core.data.buf.Distance DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new pt.sharespot.iot.core.data.buf.Distance();
  }

  public static pt.sharespot.iot.core.data.buf.Distance getDefaultInstance() {
