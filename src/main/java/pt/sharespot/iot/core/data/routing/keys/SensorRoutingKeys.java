...
public class SensorRoutingKeys implements RoutingKeys {
    ...
    public RoutingKeyOption<DeviceTypeOptions> sensorTypeId;
    ...
    private Stream<RoutingKeyOption<? extends RoutingKey>> orderedKeys() {
        return Stream.of(containerType, version, RoutingKeyOption.of(TopicTypeOptions.of("data")), infoType,
    ...
    public static class Builder {
        ...
        private RoutingKeyOption<DeviceTypeOptions> sensorTypeId;
        ...
        public Builder withSensorTypeId(String sensorTypeId) {
            this.sensorTypeId = RoutingKeyOption.of(DeviceTypeOptions.of(sensorTypeId));
            return this;
        }
        ...
        public Builder withUpdated(DataUnitDTO data) {
        ...
        public Optional<SensorRoutingKeys> from(String routingKeys) {
            ...
            this.sensorTypeId = RoutingKeyOption.of(DeviceTypeOptions.of(splinted[2]));
