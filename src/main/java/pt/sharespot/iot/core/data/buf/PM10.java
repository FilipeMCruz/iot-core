...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_PM10_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_PM10_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            pt.sharespot.iot.core.data.buf.PM10.class, pt.sharespot.iot.core.data.buf.PM10.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof pt.sharespot.iot.core.data.buf.PM10)) {
      return super.equals(obj);
    }
    pt.sharespot.iot.core.data.buf.PM10 other = (pt.sharespot.iot.core.data.buf.PM10) obj;
  ...
  public static pt.sharespot.iot.core.data.buf.PM10 parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.PM10 parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static pt.sharespot.iot.core.data.buf.PM10 parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.PM10 parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static pt.sharespot.iot.core.data.buf.PM10 parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static pt.sharespot.iot.core.data.buf.PM10 parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(pt.sharespot.iot.core.data.buf.PM10 prototype) {
  ...
  public static final class Builder extends
      ...
      pt.sharespot.iot.core.data.buf.PM10OrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_PM10_descriptor;
    }
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.PM10 getDefaultInstanceForType() {
      return pt.sharespot.iot.core.data.buf.PM10.getDefaultInstance();
    }

    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.PM10 build() {
      pt.sharespot.iot.core.data.buf.PM10 result = buildPartial();
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.PM10 buildPartial() {
      pt.sharespot.iot.core.data.buf.PM10 result = new pt.sharespot.iot.core.data.buf.PM10(this);
      if (microGramsPerCubicMeterBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof pt.sharespot.iot.core.data.buf.PM10) {
        return mergeFrom((pt.sharespot.iot.core.data.buf.PM10)other);
      } else {
    ...
    public Builder mergeFrom(pt.sharespot.iot.core.data.buf.PM10 other) {
      if (other == pt.sharespot.iot.core.data.buf.PM10.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      pt.sharespot.iot.core.data.buf.PM10 parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (pt.sharespot.iot.core.data.buf.PM10) e.getUnfinishedMessage();
  ...
  private static final pt.sharespot.iot.core.data.buf.PM10 DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new pt.sharespot.iot.core.data.buf.PM10();
  }

  public static pt.sharespot.iot.core.data.buf.PM10 getDefaultInstance() {
