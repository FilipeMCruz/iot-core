...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_Occupation_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_Occupation_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            pt.sharespot.iot.core.data.buf.Occupation.class, pt.sharespot.iot.core.data.buf.Occupation.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof pt.sharespot.iot.core.data.buf.Occupation)) {
      return super.equals(obj);
    }
    pt.sharespot.iot.core.data.buf.Occupation other = (pt.sharespot.iot.core.data.buf.Occupation) obj;
  ...
  public static pt.sharespot.iot.core.data.buf.Occupation parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.Occupation parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static pt.sharespot.iot.core.data.buf.Occupation parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.Occupation parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static pt.sharespot.iot.core.data.buf.Occupation parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static pt.sharespot.iot.core.data.buf.Occupation parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(pt.sharespot.iot.core.data.buf.Occupation prototype) {
  ...
  public static final class Builder extends
      ...
      pt.sharespot.iot.core.data.buf.OccupationOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_Occupation_descriptor;
    }
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.Occupation getDefaultInstanceForType() {
      return pt.sharespot.iot.core.data.buf.Occupation.getDefaultInstance();
    }

    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.Occupation build() {
      pt.sharespot.iot.core.data.buf.Occupation result = buildPartial();
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.Occupation buildPartial() {
      pt.sharespot.iot.core.data.buf.Occupation result = new pt.sharespot.iot.core.data.buf.Occupation(this);
      if (percentageBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof pt.sharespot.iot.core.data.buf.Occupation) {
        return mergeFrom((pt.sharespot.iot.core.data.buf.Occupation)other);
      } else {
    ...
    public Builder mergeFrom(pt.sharespot.iot.core.data.buf.Occupation other) {
      if (other == pt.sharespot.iot.core.data.buf.Occupation.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      pt.sharespot.iot.core.data.buf.Occupation parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (pt.sharespot.iot.core.data.buf.Occupation) e.getUnfinishedMessage();
  ...
  private static final pt.sharespot.iot.core.data.buf.Occupation DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new pt.sharespot.iot.core.data.buf.Occupation();
  }

  public static pt.sharespot.iot.core.data.buf.Occupation getDefaultInstance() {
