...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_Temperature_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_Temperature_fieldAccessorTable
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof pt.sharespot.iot.core.data.buf.Temperature)) {
      return super.equals(obj);
    }
    pt.sharespot.iot.core.data.buf.Temperature other = (pt.sharespot.iot.core.data.buf.Temperature) obj;
  ...
  public static pt.sharespot.iot.core.data.buf.Temperature parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.Temperature parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static pt.sharespot.iot.core.data.buf.Temperature parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.Temperature parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static pt.sharespot.iot.core.data.buf.Temperature parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static pt.sharespot.iot.core.data.buf.Temperature parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(pt.sharespot.iot.core.data.buf.Temperature prototype) {
  ...
  public static final class Builder extends
      ...
      pt.sharespot.iot.core.data.buf.TemperatureOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_Temperature_descriptor;
    }
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.Temperature getDefaultInstanceForType() {
      return pt.sharespot.iot.core.data.buf.Temperature.getDefaultInstance();
    }

    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.Temperature build() {
      pt.sharespot.iot.core.data.buf.Temperature result = buildPartial();
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.Temperature buildPartial() {
      pt.sharespot.iot.core.data.buf.Temperature result = new pt.sharespot.iot.core.data.buf.Temperature(this);
      if (celsiusBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof pt.sharespot.iot.core.data.buf.Temperature) {
        return mergeFrom((pt.sharespot.iot.core.data.buf.Temperature)other);
      } else {
    ...
    public Builder mergeFrom(pt.sharespot.iot.core.data.buf.Temperature other) {
      if (other == pt.sharespot.iot.core.data.buf.Temperature.getDefaultInstance()) return this;
      if (other.hasCelsius()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      pt.sharespot.iot.core.data.buf.Temperature parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (pt.sharespot.iot.core.data.buf.Temperature) e.getUnfinishedMessage();
  ...
  private static final pt.sharespot.iot.core.data.buf.Temperature DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new pt.sharespot.iot.core.data.buf.Temperature();
  }

  public static pt.sharespot.iot.core.data.buf.Temperature getDefaultInstance() {
