...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_CO2_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_CO2_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            pt.sharespot.iot.core.data.buf.CO2.class, pt.sharespot.iot.core.data.buf.CO2.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof pt.sharespot.iot.core.data.buf.CO2)) {
      return super.equals(obj);
    }
    pt.sharespot.iot.core.data.buf.CO2 other = (pt.sharespot.iot.core.data.buf.CO2) obj;
  ...
  public static pt.sharespot.iot.core.data.buf.CO2 parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.CO2 parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static pt.sharespot.iot.core.data.buf.CO2 parseFrom(
  ...
  public static pt.sharespot.iot.core.data.buf.CO2 parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static pt.sharespot.iot.core.data.buf.CO2 parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static pt.sharespot.iot.core.data.buf.CO2 parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(pt.sharespot.iot.core.data.buf.CO2 prototype) {
  ...
  public static final class Builder extends
      ...
      pt.sharespot.iot.core.data.buf.CO2OrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pt.sharespot.iot.core.data.buf.Sensor.internal_static_pt_sharespot_iot_core_CO2_descriptor;
    }
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.CO2 getDefaultInstanceForType() {
      return pt.sharespot.iot.core.data.buf.CO2.getDefaultInstance();
    }

    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.CO2 build() {
      pt.sharespot.iot.core.data.buf.CO2 result = buildPartial();
    ...
    @java.lang.Override
    public pt.sharespot.iot.core.data.buf.CO2 buildPartial() {
      pt.sharespot.iot.core.data.buf.CO2 result = new pt.sharespot.iot.core.data.buf.CO2(this);
      if (ppmBuilder_ == null) {
        result.ppm_ = ppm_;
      } else {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof pt.sharespot.iot.core.data.buf.CO2) {
        return mergeFrom((pt.sharespot.iot.core.data.buf.CO2)other);
      } else {
    ...
    public Builder mergeFrom(pt.sharespot.iot.core.data.buf.CO2 other) {
      if (other == pt.sharespot.iot.core.data.buf.CO2.getDefaultInstance()) return this;
      if (other.hasPpm()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      pt.sharespot.iot.core.data.buf.CO2 parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (pt.sharespot.iot.core.data.buf.CO2) e.getUnfinishedMessage();
  ...
  private static final pt.sharespot.iot.core.data.buf.CO2 DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new pt.sharespot.iot.core.data.buf.CO2();
  }

  public static pt.sharespot.iot.core.data.buf.CO2 getDefaultInstance() {
